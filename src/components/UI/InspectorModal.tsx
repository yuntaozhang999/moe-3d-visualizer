...
export const INSPECTION_DATA: {
  ...
  node_tokens: {
    title: "Input Tokens Sequence",
    category: "Embedding / Input",
    formula: "x = [t_1, t_2, \\dots, t_S] \\in \\{0, \\dots, 128255\\}^S",
  ...
  node_embed: {
    ...
    visualShape: "[1, 6, 64]",
    codeSnippet: "token_embed = reshard(_init_weight(embed_key, (128256, 6144)), P(None, None))",
